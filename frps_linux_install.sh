...
if [ $GOOGLE_HTTP_CODE == "200" ]; then
    ...
    wget -P ${WORK_PATH} https://raw.githubusercontent.com/${REPO}/main/${FRP_NAME}.toml -O ${FRP_NAME}.toml
else
    if [ $PROXY_HTTP_CODE == "200" ]; then
        ...
        wget -P ${WORK_PATH} ${PROXY_URL}https://raw.githubusercontent.com/${REPO}/main/${FRP_NAME}.toml -O ${FRP_NAME}.toml
    else
